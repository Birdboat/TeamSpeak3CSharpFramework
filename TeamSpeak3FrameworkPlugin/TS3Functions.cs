...
namespace TeamSpeak3FrameworkPlugin
{
    ...
    {
        public struct PluginMenuHelper
        {
    ...
    public class NativeConstants
    {
        ...
        public const int PATH_BUFSIZE = 512;

        public const int COMMAND_BUFSIZE = 128;

        public const int INFODATA_BUFSIZE = 128;

        public const int SERVERINFO_BUFSIZE = 256;

        public const int CHANNELINFO_BUFSIZE = 512;

        public const int RETURNCODE_BUFSIZE = 128;
